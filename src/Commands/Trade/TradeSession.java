...
public class TradeSession {
	...
	public void sendSummary() {
		String accept = "§aType §e/trade confirm§a to confirm, or §e/trade cancel§a to cancel";
		...
		init.sendMessage("§aTrading§e " + initlist + "§afor§e " + targlist);
		targ.sendMessage("§aTrading§e " + targlist + " §afor§e " + initlist);
